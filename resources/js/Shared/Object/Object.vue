...
<template>
    <div class="object_tabs">
        <div
            class="object_tab fz-14"
            :class="{ active: activeTab === 0 }"
            @click="toggleObjectTab(0)"
        >
            Объект
        </div>
        <div
