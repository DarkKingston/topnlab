...
<template>
    <div class="popup_modal">
        ...
        <div class="popup_create_main" style="position: relative;">
            <div class="popup_map_content" id="map" style="width: 100%; height: 100%;"></div>
